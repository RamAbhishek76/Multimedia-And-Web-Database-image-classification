###### Testing Script ######
# Functionality: Used this as a test script for querying images using avgpool feature
import torch
import cv2
import math
import os
...
def query_avgpool(image_id):
    ...
    if len(img) == 3:
        ...
        fig.suptitle(
            'Avgpool query top 10 outputs for input image ID ' + str(image_id), fontsize=16)
