...
csv_file_name = f"latentsemantics_task6_{k}_{feature}.csv"
text_file_name = f"latentsemantics_task6_{k}_{feature}.txt"
...
similarity_matrix = np.loadtxt(csv_file_name, delimiter=",")
...
csv_file_name_for_sortedweightpairs = f"imageweightpairs_task6_{dim_red_method}_{feature_names[feature-1]}_{k}.csv"
