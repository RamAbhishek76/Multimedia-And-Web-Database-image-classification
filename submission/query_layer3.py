###### Testing Script ######
# Functionality: Used this as a test script for querying images using layer3 feature
import torch
import cv2
import numpy
...
def query_layer3(image_id):
    ...
    if len(img) == 3:
        ...
        fig.suptitle(
            'Layer 3 query top 10 outputs for input image ID ' + str(image_id), fontsize=16)
